...
module.exports = {
  ...
  systemName: 'Ruichen Admin',         //系统名称
  copyright: '2020 Richard 工作室出品',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://www.cnblogs.com/lulifa/', name: '博客园-卤菜大煎饼'},
    {link: 'https://github.com/lulifa', icon: 'github'},
    {link: 'https://gitee.com/lulifa', icon: 'gitlab'}
  ],
}
